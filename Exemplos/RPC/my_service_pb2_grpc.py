...
class MyServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SayHello = channel.unary_unary(
                '/my_service.MyService/SayHello',
                request_serializer=my__service__pb2.HelloRequest.SerializeToString,
                response_deserializer=my__service__pb2.HelloResponse.FromString,
                )
...
def add_MyServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SayHello': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=my__service__pb2.HelloResponse.SerializeToString,
            ),
    }
...
class MyService(object):
    ...
    def SayHello(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/my_service.MyService/SayHello',
            my__service__pb2.HelloRequest.SerializeToString,
            my__service__pb2.HelloResponse.FromString,
